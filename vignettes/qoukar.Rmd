...
```{r high_lm1, eval=TRUE, echo=TRUE, fig.align="center", fig.height=3, fig.width=3, fig.cap = "Case 1 outliers simulation study of mean regression"}

```

```{r high_rq1, eval = TRUE, echo = TRUE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Case 1 outliers simulation study of quantile regression"}

```

* Outliers affect regression on low quantile

```{r low_lm1, eval = TRUE, echo = TRUE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Case 2 outliers simulation study of mean regression"}

```

```{r low_rq1, eval = TRUE, echo = TRUE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Case 2 outliers simulation study of quantile regression"}
...
```{r move_y1,warning=FALSE,message=FALSE, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Move in y-direction"}
...
```{r move_y_multi1,warning=FALSE,message=FALSE, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Move in y-direction Multi-variable Case"}
...
```{r move_x1,warning=FALSE,message=FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Move in x-direction"}
...
```{r outlier_number1,warning=FALSE,message=FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Adding more Outliers"}
...
```{r real_data1, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Real Data Example"}
...
```{r simplex_method1, warning=FALSE,message=FALSE,fig.height=3, fig.width=3, fig.align = "center", fig.cap="Observations used in Simplex Method"}
...
```{r fn_method1,warning=FALSE,message=FALSE, fig.height=3, fig.width=3, fig.align = "center", fig.cap="Observations weighted in Interior Point Algorithm"}

```

```{r fn_weights1,warning=FALSE,message=FALSE, fig.height=3, fig.width=3, fig.align = "center", fig.cap="Weights in Interior Point Algorithm"}
...
```{r frame_nlrq1,warning=FALSE,message=FALSE, fig.height=3, fig.width=3, fig.align = "center", fig.cap="Weighting in Non-linear Quantile Regression"}
...
```{r ALD1,warning=FALSE,message=FALSE, results = "hide",fig.height=3, fig.width=3, fig.align = "center", fig.cap="Asymmetric Laplace Distribution" }
...
```{r Residual_Robust1,warning=FALSE,message=FALSE, fig.height=3, fig.width=3, fig.align = "center", fig.cap="Robust Distance-Residual Plot"}
...
```{r GCD1,warning=FALSE,message=FALSE, results = "hide", fig.height=3, fig.width=3, fig.align = "center", fig.cap="Generalized Cook Distance"}
...
```{r QD1, warning=FALSE, message=FALSE, results = "hide", fig.height=3, fig.width=3, fig.align = "center", fig.cap="Q-function Distance"}
...
```{r BP1,warning=FALSE,message=FALSE, fig.height=3, fig.width=3, fig.align = "center", fig.cap="Mean Posterior Probability"}
...
```{r BKL1,warning=FALSE,message=FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Kullback and Leibler Divergence"}
