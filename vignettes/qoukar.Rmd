...
```{r GCD1,warning=FALSE,message=FALSE, results = "hide", fig.height=3, fig.width=8, fig.align = "left", fig.cap="**Figure 20. **Generalized cook distance of each observation on quantile 0.1, 0.5 and 0.9. Case 75 has relative large q-funtion distance to other points"}
...
```{r QD1, warning=FALSE, message=FALSE, results = "hide", fig.height=3, fig.width=7, fig.align = "left", fig.cap="**Figure 21. **Q-function distance of each observation on quantile 0.1, 0.5 and 0.9 from left to right. Case 75 has relative large q-funtion distance to other points."}
