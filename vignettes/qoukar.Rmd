...
```{r high_lm, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center"}
...
```{r real_data, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Figure1. Mean Regression"}
