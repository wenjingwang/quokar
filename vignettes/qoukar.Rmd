...
* Simulation study 1: outliers affect regression on high quantile
...
```{r high_lm, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Outliers simulation study of mean regression"}

```

```{r high_rq, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Outliers simulation study of quantile regression"}

```

* Simulation study 2: outliers affect regression on low quantile

```{r low_lm, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Outliers simulation study of mean regression"}



```

```{r low_rq, eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Outliers simulation study of quantile regression"}
...
```{r move_y,warning=FALSE,message=FALSE, eval = TRUE, echo = FALSE}
...
```{r move_y_multi,warning=FALSE,message=FALSE, eval = TRUE, echo = FALSE}
```
...
```{r eval = TRUE, echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", fig.cap = "Figure1. Mean Regression"}
...
```{r ALD,warning=FALSE,message=FALSE, results = "hide"}
```
...
```{r GCD,warning=FALSE,message=FALSE, results = "hide"}
```
...
```{r QD, warning=FALSE, message=FALSE, results = "hide"}
